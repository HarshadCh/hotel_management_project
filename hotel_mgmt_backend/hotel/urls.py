...
from .views import all_customer_list,insert_customer,single_customer,update_customer,delete_customer,check_in_filter
...
urlpatterns = [
    ...
    path('check_in_filter/',check_in_filter,),
]